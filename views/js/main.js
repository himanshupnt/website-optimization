...
var resizePizzas = function(size) {
  ...
  changeSliderLabel(size);
   ...
   // Removed determineDx function and refactored code
...
//moved out items variable to global scope and use of more effecient class selecetor
...
function updatePositions() {
  ...
  for (var i = 0; i < 5; i++) {
    phase.push(Math.sin(scrollPos + i)); //took out Math.sin from the loop below
  }
    
  for (var i = 0; i < itemLength; i++) {
     //Change the transform: translateX property to replace expensive style.left 
...
document.addEventListener('DOMContentLoaded', function() {
  var cols = 8;
  var s = 256;
  var movingPizzas = document.getElementById('movingPizzas1'); //moved this reference out of the loop below and used Id selector
  for (var i = 0; i < 40; i++) { //reduced number of pizzas
